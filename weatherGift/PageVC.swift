...
//  weatherGift
//
//  Created by Stephen Casazza on 10/15/17.
...
class PageVC: UIPageViewController {
    ...
    var currentPage = 0
    var locationsArray = ["Local City", "Sydney, Australia", "Uglich, Russia", "Albertson, New York"]
    ...
    // MARK: Create UI View Controller for UIPageViewController
